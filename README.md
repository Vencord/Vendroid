...
You are likely better off using [Aliucord](https://github.com/Aliucord/Aliucord) or [Revenge](https://github.com/revenge-mod/revenge-bundle) that are proper mods of the old and new Discord Android app respectively.
